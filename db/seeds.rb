...
Player.create(playername: "FergySenpai", player_role1: "Off-lane", player_role2: "Mage", player_role3: "ADC")
Player.create(playername: "Administrator", player_role1: "Tank", player_role2: "Healer", player_role3: "Off-lane")
